              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    placeholder="Default: PT. ONE SEULANGA NUSANTARA"
                    :disabled="sedangSimpan"
                  >
                </div>
              </div>
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    type="text"
                    class="w-full pl-10 pr-4 py-3 text-sm bg-[#050a14]/50 border border-slate-700/60 text-white placeholder-slate-500 focus:bg-[#070f1e] focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 rounded-xl transition-all outline-none"
                    placeholder="Instansi / individu tujuan"
                    :disabled="sedangSimpan"
                  >
                </div>
              </div>
              ...
              <tbody class="divide-y divide-slate-700/50">
                ...
                >
                  ...
                  <td class="px-4 py-4 whitespace-nowrap">
                    <span class="px-2.5 py-1 rounded-full text-xs font-bold bg-orange-500/15 text-orange-400 border border-orange-500/30">
                      {{ surat.jenisSurat }}
                    </span>
                  </td>
