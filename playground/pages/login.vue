<template>
  <div class="relative min-h-screen flex bg-[#0a1628] overflow-hidden lg:grid lg:grid-cols-2">
    <!-- Bagian Kiri: Visual & Branding (Desktop - Background Putih untuk menyatukan gambar secara mulus) -->
    <div class="hidden lg:flex relative flex-col items-center justify-center overflow-hidden bg-[#fefefe] p-12 border-r border-slate-200">
      <!-- Background Batik (Subtle Watermark) -->
      <div class="absolute inset-0 z-0 pointer-events-none select-none">
        <img 
          src="/batik.png" 
          alt="Batik Pattern" 
          class="w-full h-full object-cover opacity-[0.05] mix-blend-multiply" 
        />
      </div>
      ...
      <div class="relative z-10 flex flex-col items-center justify-center text-center">
        <!-- Logo Utama OSN -->
        <div class="relative mb-6 max-w-[280px]">
          <img 
            src="/osnlogo.jpeg" 
            alt="Logo OSN" 
        ...
        <p class="max-w-md text-sm leading-relaxed text-slate-500 font-medium mt-4">
          Platform Sistem Informasi terintegrasi dengan sentuhan kearifan lokal. Memberikan solusi efisien untuk manajemen perusahaan Anda.
        </p>
      </div>
    </div>

    <!-- Bagian Kanan: Form Login (Background Gelap dengan Glass Card Asli) -->
    <div class="relative flex flex-col items-center justify-center px-4 py-8 lg:p-12 bg-[#0a1628]">
      ...
      <!-- Background Batik Mobile (Subtle) -->
      <div class="absolute inset-0 z-0 lg:hidden pointer-events-none select-none">
        <img 
          src="/batik.png" 
          alt="Batik Pattern" 
          class="w-full h-full object-cover opacity-[0.03] mix-blend-overlay"
        />
      </div>

      <div class="relative z-10 flex w-full max-w-sm flex-col items-center gap-6">
        <!-- Header Logo (Mobile Only) -->
        <div class="flex flex-col items-center gap-4 text-center lg:hidden">
          <div class="bg-white rounded-2xl p-2.5 shadow-lg max-w-[180px]">
            <img
              src="/osnlogo.jpeg"
              alt="Logo OSN"
              class="w-full h-auto object-contain"
