      ...
      <main class="flex flex-col gap-5 p-5">
        ...
        <div class="glass-card p-6 max-w-2xl">
          ...
          >
            ...
            >
              <div
                ...
                class="flex items-center gap-2 text-xs rounded-xl px-3.5 py-2.5 border"
                :class="rentangHari > 3
            ...
            <button
              type="submit"
              class="btn-primary !w-auto self-end"
          ...
          >
            <div
              v-if="pesanSukses"
              class="mt-5 flex items-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/10 px-3.5 py-2.5 text-sm text-emerald-300"
            >
              <LucideCheckCircle2 :size="16" />{{ pesanSukses }}
            </div>
            <div
              v-else-if="pesanError"
              class="mt-5 flex items-center gap-2 rounded-xl border border-red-500/25 bg-red-500/10 px-3.5 py-2.5 text-sm text-red-300"
            >
